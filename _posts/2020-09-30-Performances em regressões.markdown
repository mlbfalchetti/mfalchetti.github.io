...
As tarefas de aprendizagem de máquina devem possuir um medidor de performance, para que você consiga avaliar se os modelos estão realizando altas taxas de acertos ou de erros. 
</p>
